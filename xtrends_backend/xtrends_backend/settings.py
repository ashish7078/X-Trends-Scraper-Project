...
ROOT_URLCONF = 'xtrends_backend.urls'
...
WSGI_APPLICATION = 'xtrends_backend.wsgi.application'
...
# This correctly handles Vercel's preview domains and local development.
